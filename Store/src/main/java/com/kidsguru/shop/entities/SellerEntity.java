...
public class SellerEntity {
    ...
    public SellerEntity(String sellerName, String sellerEmail, String phone) {
        this.sellerName = sellerName;
        this.sellerEmail = sellerEmail;
        this.phone = phone;
    }

    public SellerEntity(int sellerId, String sellerName, String sellerEmail, String phone) {
